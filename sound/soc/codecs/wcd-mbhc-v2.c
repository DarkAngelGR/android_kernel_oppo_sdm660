...
/* Yongzhi.Zhang@PSW.MM.AudioDriver.HeadsetDet.1473948, 2018/07/10,
 * modify for closing 3uA pull up control of internal detection
 */
...
#define pr_debug pr_info
	...
	/* Yongzhi.Zhang@PSW.MM.AudioDriver.HeadsetDet.1476958, 2018/08/16,
	 * add for Headset detect.
	 */
...
static int wcd_mbhc_initialise(struct wcd_mbhc *mbhc)
{
	 ...
	 */
	{
		if ((is_project(OPPO_18316))
		  || (is_project(OPPO_18005))
		  || (is_project(OPPO_18321))
		  || (is_project(OPPO_18323)))
		{
