...
struct devinfo_data {
	...
	struct pinctrl_state *hw_RFverify_gpio_HW_ID1_pullup;   //#ifdef CONFIG_VENDOR_REALME Wanghao@BSP.TP.Basic 2017-09-26 add for verify RFmode
	...
	int wlan_hw_id1;
	int wlan_hw_id2;
	int hw_RFver1_gpio;     //#ifdef CONFIG_VENDOR_REALME Wanghao@BSP.TP.Basic 2017-09-26 add for verify RFmode
	int hw_RFver2_gpio;
	int hw_RFver3_gpio;
