...
#ifdef CONFIG_VENDOR_REALME//Fanhong.Kong@PSW.BSP.CHG, 2018/1/18, Add for transaction release 2times,case 03307495
/**
...
#ifndef CONFIG_VENDOR_REALME//Fanhong.Kong@PSW.BSP.CHG, 2018/1/18, Add for transaction release 2times,case 03307495			
/*			if (t->buffer->target_node &&
			    !(t->flags & TF_ONE_WAY)) {
