...
#elif CONFIG_OPPO_FINGERPRINT_PLATFORM == 8953 || CONFIG_OPPO_FINGERPRINT_PLATFORM == 8976  /* msm8953, 8976pro */
#define OEM_SEC_BOOT_REG 0xA0154
#endif
#ifdef OPPO_FINGERPRINT_SUPPORT
extern char g_engineermode_menu_config[ENGINEER_MENU_SELECT_MAXLENTH];
#else
#define ENGINEER_MENU_DEFAULT  "-1,-1"
static char g_engineermode_menu_config[ENGINEER_MENU_SELECT_MAXLENTH] = ENGINEER_MENU_DEFAULT;
#endif /*OPPO_FINGERPRINT_SUPPORT*/
static struct proc_dir_entry *oppo_secure_common_dir = NULL;
static char* oppo_secure_common_dir_name = "oppo_fp_common";
...
#elif CONFIG_OPPO_FINGERPRINT_PLATFORM == 8953 /*msm8953*/
...
#elif CONFIG_OPPO_FINGERPRINT_PLATFORM == 8976 /*msm8976pro*/
...
static ssize_t engineermode_menuinfo_read_proc(struct file *file, char __user *buf,
                size_t count, loff_t *off)
{
        char page[256] = {0};
        int len = 0;

        len = sprintf(page, "%s", g_engineermode_menu_config);
...
static struct file_operations engineermode_menuinfo_proc_fops = {
        .read = engineermode_menuinfo_read_proc,
};
...
static int secure_register_proc_fs(struct secure_data *secure_data)
{
        ...
        /*  make the dir /proc/oppo_fp_common  */
        ...
        /*  make the proc /proc/oppo_fp_common/secureType  */
        ...
        /*  make the proc /proc/oppo_fp_common/secureSNBound  */
        ...
        /*  make the proc /proc/oppo_fp_common/engineermode_menuinfo  */
        pentry = proc_create("engineermode_menuinfo", 0444, oppo_secure_common_dir, &engineermode_menuinfo_proc_fops);
        if(!pentry) {
                dev_err(secure_data->dev,"create engineermode_menuinfo proc failed.\n");
                return SECURE_ERROR_GENERAL;
        }
